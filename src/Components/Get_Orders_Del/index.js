...
class Admin_Panel_Entered_Get_Orders extends Component {
    ...
    Get() {
        fetch('https://rotiappp.herokuapp.com/api/orders/Delivered', {
            method: "GET"
    ...
    //     }).then(function (response) {
    //         return response.json();
    //     }).then(data => console.log("The Item has been Deleted")
    //     ).catch(error => console.log("error"));
    // }
    Update(dt) {
                                ...
                                this.state.resArray.map((data, i) => {
                                    return (
                                        <tr key={i}>
                                            ...
                                            {/* <td><button onClick={() => this.Update(data)}>Update</button></td> */}
...
export default Admin_Panel_Entered_Get_Orders;
